...
(function ($) {
    ...
    $.alerts = {
        ...
        verticalOffset: -25,                // vertical offset of the dialog from center screen, in pixels
        ...
        _show: function (title, msg, value, type, callback) {
            ...
            $("BODY").append(
			  '<div id="popup_container" style ="border-radius:6px;border:2px solid #dcdcdc; data-rel="back" data-role="button" data-theme="a" data-icon="delete" data-iconpos="notext" class="ui-btn-right ">' +
			    '<h1 id="popup_title" style="margin-left:25px;  margin-top:5px;font-size:12px;font-family:Verdana;" ></h1>' +

			    '<div id="popup_content" style=" margin-top:5px;margin-left:5px;border-radius:3px;width:250px;height:70px;">' +
			      '<div id="popup_message" style=" text-align:left"></div>' +
				'</div>' +
			  '</div>');
            $("#popup_title").after('<div id="popup_panel23" style=" margin-top:4px;font-size:12px;border-bottom: solid #181818 2px;"></div>');
            ...
            //            style="float: right;margin-top:-5px; height: 25px; width: 25px;" alt="" src="../Content/themes/base/images/DeleteImage.jpg">
            //    $("#popup_title").append('<input type="button" id="close_message"style="float: right;margin-top:-5px; height: 25px; width: 25px;" alt="" src="../Content/themes/base/images/DeleteImage.jpg"  />');
            $("#popup_content").addClass(type).css({
...
//                                                height: '120',
            ...
            switch (type) {
                case 'alert':
                    //                    $("#popup_message").after('<div id="popup_panel"><input type="button" value="' + $.alerts.okButton + '" id="popup_ok"   style=" margin-top:40px;margin-left:100px;background:#3295eb;border-radius:3px;"  /></div>');
                    ...
                    break;
                case 'confirm':
                    $("#popup_message").after('<div id="popup_panel"><input type="button" value="' + $.alerts.okButton + '" id="popup_ok"  style="margin-top:25px;margin-left:35px;" /> <input type="button" value="' + $.alerts.cancelButton + '" id="popup_cancel"   style="margin-top:25px;margin-left:20px;"/></div>');
                    $("#popup_ok").click(function () {
                        //                        $.alerts._hide();
                        //                        if (callback) callback(true);
                     //  window.location.href = '../ActivityUI/grid'
...
//                                               
                        ...
                        //                        window.location.href = '../EmployeePersonal/EmployeeGrid'
                    });
                    $("#popup_ok").focus();
...
//                    });
                    break;
                case 'prompt':
                    $("#popup_message").append('<br /><input type="text" size="30" id="popup_prompt" />').after('<div id="popup_panel"><input type="button" style="align:center;" value="' + $.alerts.okButton + '" id="popup_ok" /> <input type="button" value="' + $.alerts.cancelButton + '" id="popup_cancel" /></div>');
...
//                    });
                ...
                case 'promptMulti':
                    ...
                    $("#multiPromptNewValue").click(function () {
                        $("#popup_message")
							.append('<br /><input type="text"  class="popup_multiPrompt" value=""/>');
                        $(".popup_multiPrompt").width($("#popup_message").width());

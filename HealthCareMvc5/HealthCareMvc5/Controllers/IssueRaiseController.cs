...
{
    public class IssueRaiseController : Controller
    {
        ...
        public ActionResult AjaxHandler(jQueryDataTableParamModel param)
        {
            ...
            var result = from c in local
                         select new[] {
                             ...
                             c.IssueType,//7
                             c.ShortNmae,//9
                              "<center><i id='iconDelete' data-toggle='tooltip' title='Delete' class='icon-cSize fa fa-trash delete'></i></button><center>",//9 
                             c.CreatedDate1,//10
                             
                             c.ModuleID.ToString(),//12
                             c.FormID.ToString(),//13
                             c.ProductID.ToString(),//14
                             c.IssueTypeID.ToString(),//15
                             c.ClientNameID.ToString(),//16
                             c.Filecount.ToString()//17
                ...
                using (cmd = new SqlCommand("Sp_ListClientIssueRaisePages", conn))
                {
                    ...
                    if (reader.NextResult())
                    {
...

                        {
                            ...
                            objissue.CreatedDate2 = DBNull.Value.Equals(reader["IssueRaiseDate"]) ? DateTime.Now : Convert.ToDateTime(reader["IssueRaiseDate"]);//9
        ...
        public JsonResult GetAllFileById(Int64 IssueDetailID)
        {
